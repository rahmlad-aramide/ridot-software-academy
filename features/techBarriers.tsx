  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-10 px-5 pt-[50px] pb-[20px] md:flex-row md:gap-6 md:px-10 lg:gap-10 lg:px-15">
      ...
      <div className="mx-auto w-full space-y-5">
        ...
        <Link
          href="/enroll"
          className="bg-primary mt-5 block w-fit rounded px-4 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none lg:mt-7"
        >
          Enroll Now
        </Link>
      </div>
