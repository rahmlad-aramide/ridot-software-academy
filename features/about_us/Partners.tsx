      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-3 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {partners.map((partner) => (
            <div
              key={partner.id}
              className="flex items-center justify-center gap-2 rounded-lg bg-gray-50 p-6 text-center text-lg font-semibold text-gray-700 shadow-sm transition-all hover:bg-gray-100"
            >
              {partner.logo ? (
                <Image
                  src={partner.logo}
