...
export default function PopupForm({ isOpen, onClose } : PopupFormProps) {
  ...
  return (
   <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-60 backdrop-blur-sm p-5 xs:p-10 md:p-0">
      <div className="relative bg-white shadow-[0_4px_20px_rgba(2,1,129,0.63)] backdrop-blur-[25px] w-full md:max-w-xl rounded-[20px] p-6">
      
            <button onClick={onClose}
                    className='absolute top-3 right-3 text-gray-500 text-2xl font-bold cursor-pointer'>&times;</button>
<h1 className="text-xl font-bold">Enroll</h1>
    ...
    enableSearch={false}
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-7'>
        ...
        <button type='submit' className="w-full bg-[rgb(1,0,128)] text-sm text-white py-2 rounded-md mt-5 cursor-pointer">Enroll Now</button>
      </form>
    </div>
  </div>
