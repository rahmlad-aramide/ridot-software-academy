...
export const blogPosts = [
  {
    ...
    image: blog5,
    title: 'Insights from Our Free Digital Skills Training for 150 Women',
    category: 'general',
    excerpt:
      'It has been a remarkable experience at digital skills training organized by Ridot. This initiative demonstrates our commitment to empowering women through transformative tech knowledge...',
    content: `
      <p>It has been a remarkable experience at digital skills training organized by Ridot. The program, which focuses on women and started in the month of October, has been a bedrock of knowledge for the beneficiaries.</p>
  ...
  },
  {
    ...
    category: 'data',
    excerpt:
      'Learning data science is one of the boldest steps you can take in 2026. As technology evolves, the demand for data-driven insights continues to grow, making data science an invaluable skill in the digital space...',
    content: `
      <p>Learning data science is one of the boldest steps you can take in 2026. As the world evolves, so does technology, and there is a need for every individual to level up in the digital space. Data science, as it is known, is a field that uses scientific methods to analyze data and extract insights. </p>
  ...
  },
  {
    ...
    content: `
        ...
        <h2 class="text-2xl font-semibold mt-4 mb-2">Technological Areas Applicable to Program Management</h2>
        <p>In recent times, many skills now have their technological areas. That of program management includes:</p>
        <ul class="list-disc list-inside mb-4">
          <li>Application of communication and management tech tools like: Jira, Trello, Microsoft Project</li>
          <li>Application of analytical tools: Excel, SQL... to handle data, using analytics tools, and understanding metrics to track project progress and make data-driven decisions</li>
        </ul>
        <h2 class="text-2xl font-semibold mt-4 mb-2">Essential Non-Tech Skills</h2>
        <ul class="list-disc list-inside mb-4">
  ...
  },
  {
    ...
    content: `
        ...
        <p>Technology in Nigeria has evolved significantly over the years. In the early days, technological advancements were mainly driven by the oil and gas industry. However, the democratization of the internet in the late 20th century opened up new opportunities for innovation. In the 2000s, mobile telecommunications began to flourish with the widespread adoption of mobile phones and the emergence of mobile money services.</p>
        <p>The mid-2000s saw the establishment of tech hubs and incubators, such as co-creation Hub (CcHub) and iDEA Hub, which played a crucial role in nurturing startups and fostering innovation. In 2010, the Nigerian government launched the National Information Technology Development Agency (NITDA) to promote the development and regulation of information technology in the country.</p>
  ...
  },
  {
    ...
    content: `
        ...
        <p>Here are some of the technical careers women can look into:</p>
        <ul class="list-disc list-inside mb-4">
        ...
        <h3 class="text-xl font-semibold mt-4 mb-2">Computer Programming</h3>
        <p>This is a programming skill that has a wide range of acceptance in the tech industry yet, we have very few women who are stepping up in it. It involves learning programming languages like Java, Python, C++, C#, etc., or markup languages to build software applications. A woman who specializes in this field is called a female developer/programmer.</p>
        <h3 class="text-xl font-semibold mb-2">Web Development</h3>
        <p>Learning web development includes front-end, back-end, and product design. One can choose to specialize in one of these or become a full-stack developer.</p>
        <h3 class="text-xl font-semibold mb-2">Data Science</h3>
        <p>This entails the application of machine learning using either supervised or unsupervised learning to train and test a data set. A person who studies this is called a data scientist.</p>
        <h3 class="text-xl font-semibold mb-2">Product Design</h3>
        <p>This is another career that doesn&apos;t require coding. It is the design interface of a website. In this case, the designer follows the design principles and the user needs to create a stunning website.</p>
        <h3 class="text-xl font-semibold mb-2">DevOps</h3>
        <p>This is a software technical development of a computer, the person who does this is called a DevOps engineer. They equally see to the internal technical faults, the overall working of the system as well as others.</p>
        <h3 class="text-xl font-semibold mb-2">Digital Marketing</h3>
        <p>This involves the online means of selling products and services. The various means of selling can include:</p>
        <ul class="list-disc list-inside mb-4">
