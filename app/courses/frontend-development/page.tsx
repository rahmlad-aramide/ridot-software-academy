      ...
      <div className="xs:h-[650px] relative h-[590px] w-full md:h-[530px]">
        ...
        <div className="xs:max-w-[600px] xs:px-[30px] xs:pt-[80px] absolute top-0 flex w-full flex-col space-y-5 px-[20px] pt-[50px] text-white md:max-w-[700px] md:px-0 md:pt-[60px] md:pl-[40px] lg:pl-[80px]">
          ...
          <p className="xs:text-2xl text-sm md:text-xl">
            Build modern, responsive user interfaces using HTML, CSS,
            JavaScript, and React.js. Gain all the essential skills needed to
      ...
      <div className="xs:-mt-[80px] relative z-10 -mt-[60px] md:-mt-[40px]">
        <div className="xs:max-w-[430px] mx-auto flex max-w-[288px] flex-col rounded-[10px] bg-white p-[24px] text-base text-[rgb(1,0,128)] shadow-[0_4px_20px_rgba(0,0,0,0.1)] backdrop-blur-[15px] md:max-w-[698px] md:flex-row md:gap-5">
          ...
          <div className="xs:space-y-2 xs:flex-row xs:gap-5 mt-5 flex flex-col space-y-5 md:mt-0 md:flex-col">
            ...
            <p className="font-bold">
              Outcome: <span className="font-normal">Become a Front-End Developer</span>
            </p>
          </div>
        </div>
      </div>
