...
export default function Page() {
  return (
    <main>
      <div className="xs:h-[650px] relative h-[590px] w-full md:h-[530px]">
        ...
        <div className="xs:max-w-[600px] xs:px-[30px] xs:pt-[80px] absolute top-0 flex w-full flex-col space-y-5 px-[20px] pt-[50px] text-white md:max-w-[700px] md:px-0 md:pt-[60px] md:pl-[40px] lg:pl-[80px]">
          <h1 className="xs:text-5xl text-[40px] leading-tight font-bold md:text-6xl">
            Front-end Development
          </h1>
          <p className="xs:text-2xl text-sm md:text-xl">
            Let&apos;s help you become a professional Front-End Web Developer.
            You&apos;ll gain all the essential skills needed to build
            interactive and responsive web applications while creating an
            impressive portfolio. Learn the fundamentals of HTML, CSS,
            JavaScript, React, and modern front-end development techniques,
            along with deployment using platforms like Vercel.
          </p>
          <button
            type="button"
      ...
      <div className="xs:-mt-[80px] relative z-10 -mt-[60px] md:-mt-[40px]">
