...
import Section from '@/app/courses/data-science/section';
  ...
  return (
    <main>
      <div className="xs:h-[600px] relative h-[520px] w-full md:h-[530px]">
        ...
        <div className="xs:max-w-[600px] xs:px-[30px] xs:pt-[80px] absolute top-0 flex w-full flex-col space-y-5 px-[20px] pt-[50px] text-white md:max-w-[700px] md:px-0 md:pt-[60px] md:pt-[100px] md:pl-[40px] lg:pl-[80px]">
      ...
      <div className="xs:-mt-[100px] relative z-10 -mt-[140px] md:-mt-[70px]">
