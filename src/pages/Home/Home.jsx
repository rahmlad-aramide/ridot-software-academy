  ...
  return (
    <section className="flex flex-col md:flex-row gap-5 items-center h-full md:h-[80vh] md:max-h-[500px] w-[90%] max-w-[1200px] mx-auto">
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start my-10">
        ...
        <Link
          to="/pricing"
          className="bg-primary text-white w-fit rounded-lg px-4 sm:px-10 py-2 sm:py-3 font-medium flex shrink-0 transition duration-300 active:scale-100 hover:scale-90"
        >
          Get Started
        </Link>
      </div>
      <div className="w-full md:w-1/2">
        <div className="relative mr-8">
          <img
            src={hero}
            alt="Ridot Software Academy"
            className="z-10 rounded-3xl animate-bounce"
          />
          <div className="bg-primary h-full w-full absolute rounded-3xl top-8 -right-8 -z-10 shadow-xl"></div>
        </div>
      </div>
    </section>
  );
    ...
    <>
      <section className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-20 w-[90%] max-w-[1200px] mx-auto">
        <div className="group border p-10 shadow-[0px_13px_19px_0px_rgba(0,0,0,0.07)] transition-all duration-300 bg-white hover:bg-primary rounded-lg">
          ...
          <h2 className="text-[#252B42] group-hover:text-white font-Montserrat font-bold my-5">
          ...
          <p className="text-[#252B42] group-hover:text-white text-sm">
            Our specially curated programs focus on fostering a supportive
            learning environment, ensuring that women not only gain technical
            skills but also build confidence to thrive in the tech industry.
          </p>
        </div>
        <div className="group border p-10 shadow-[0px_13px_19px_0px_rgba(0,0,0,0.07)] transition-all duration-300 bg-white hover:bg-primary rounded-lg">
          ...
          <div className="w-16 h-1 bg-secondary group-hover:bg-white mb-5"></div>
          <p className="text-[#252B42] group-hover:text-white text-sm">
            Whether you&rsquo;re a professional, a student, or a homemaker, our
            adaptive programs allow you to balance your responsibilities while
        ...
        <div className="group border p-10 shadow-[0px_13px_19px_0px_rgba(0,0,0,0.07)] transition-all duration-300 bg-white hover:bg-primary rounded-lg">
              ...
              <g>
                <g>
                  <g>
                    <path
                      className="fill-white group-hover:fill-primary"
                      d="M111.781,235.411l18.751,18.751H78.754c0-23.873,17.417-32.868,41.021-35.184l-10.566,10.579
          ...
          <div className="w-16 h-1 bg-secondary group-hover:bg-white mb-5"></div>
          <p className="text-[#252B42] group-hover:text-white text-sm">
            Stand a chance to be part of a network that encourages
            collaboration, mentorship, and the celebration of women&rsquo;s
            achievements in the software industry.
          </p>
        </div>
      </section>
    </>
      ...
      <div className="w-full md:w-1/2 mt-16 md:mt-0">
        <div className="h-full flex justify-center items-center relative ml-8">
          <img
            ...
            className="z-10 rounded-3xl animate-bounce shadow-xl"
          />
          <div className="bg-secondary h-full w-full absolute rounded-3xl top-6 md:top-8 right-6 md:right-8 -z-10 shadow-xl"></div>
        </div>
      </div>
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start md:ml-8 mt-16 md:mt-8 mb-10">
        <div className="h-1 w-20 bg-secondary mb-5"></div>
        <h1 className="text-primary text-2xl sm:text-3xl text-center md:text-left font-Montserrat font-bold">
          Solving Tech Phobia in females.
        </h1>
        <p className="text-[#4F596A] text-center text-lg md:text-left max-w-[40ch] md:max-w-full mt-5 mb-10">
          ...
          women to start a career in tech.
        </p>
        <Link
          to="/about"
          className="bg-primary text-white w-fit rounded-lg px-4 sm:px-10 py-2 sm:py-3 font-medium flex shrink-0 transition duration-300 active:scale-100 hover:scale-90"
  ...
  return (
    <section className="flex flex-col justify-center items-center my-20">
      <div className="bg-secondary bg-opacity-20 mb-8 rounded-full">
        <h1 className="text-secondary uppercase text-xs md:text-sm font-bold px-4">
          Unlock exclusive savings now!{" "}
        </h1>
      </div>
      <h2 className="text-3xl md:text-[46px] leading-normal font-bold text-primary font-Montserrat max-w-[20ch] mb-8 text-center">
        Ready to enjoy our ongoing discount?
      </h2>
      <Link
        to="/pricing"
        className="bg-primary text-white w-fit rounded-lg px-4 sm:px-10 py-2 sm:py-3 font-medium flex shrink-0 transition duration-300 active:scale-100 hover:scale-90"
