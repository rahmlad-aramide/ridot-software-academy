...
const Blog = () => {
  ...
  const filteredPosts = blogPosts.filter(post => currentCategory === 'all' || post.category === currentCategory);
      ...
      <div className='w-[90%] max-w-[1200px] mx-auto pt-5'>
        ...
        <div className='flex flex-col sm:flex-row justify-between pb-1 md:pb-0'>
          ...
          <div className="hidden md:flex gap-[10px]">
            ...
            <button onClick={() => handleCategory('engineering')} className={currentCategory === 'engineering' ? "px-[10px] py-[2px] bg-[#CED4DC] rounded text-[13px]" : "px-[10px] py-[2px] text-[13px]"}>Engineering</button>
            <button onClick={() => handleCategory('design')} className={currentCategory === 'design' ? "px-[10px] py-[2px] bg-[#CED4DC] rounded text-[13px]" : "px-[10px] py-[2px] text-[13px]"}>Design</button>
            <button onClick={() => handleCategory('product')} className={currentCategory === 'product' ? "px-[10px] py-[2px] bg-[#CED4DC] rounded text-[13px]" : "px-[10px] py-[2px] text-[13px]"}>Product</button>
          </div>
