      ...
      <div className="w-[90%] max-w-[1200px] mx-auto">
        <div className="flex flex-col w-full items-center mb-10 mt-10">
          ...
          <p className="text-center max-w-2xl mt-4 text-lg">
            We celebrate the courage of every woman who applied for the 150
            Women Free Digital Skills Training. Even if you were not selected
            this time, your passion for growth and technology deserves
            recognition. 💻✨ 
          </p>
          <p className="text-center max-w-2xl mt-4 text-lg">
            That’s why we are excited to announce a{" "}
            <strong>Scholarship on ALL Ridot courses</strong>, specially for
            you. 🎉
            <strong>Offer ends 20th September 2025.</strong>
          </p>
          <p>Message - <a href="tel:+2347083143779">07083143779</a> after payment.</p>
        </div>
