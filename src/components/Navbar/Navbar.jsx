  ...
  return (
    <>
      <header className="w-full fixed top-0 z-50">
        <div
          className={`bg-white/30 backdrop-blur-lg shadow h-16 md:h-20 flex justify-center w-full z-50 border-b border-[rgba(0,0,0,0.20)] fixed md:static top-0'}`}
        >
          <div className="flex justify-between items-center w-[90%] max-w-[1200px] mx-auto">
            ...
            <button
              ...
              className="fixed md:hidden top-6 right-8 sm:right-8 z-50 transition duration-200 hover:scale-125 active:scale-100"
            >
              <div>
            ...
            <nav
              ref={navRef}
              className="bg-white -translate-y-[calc(100%_+_200px)] md:translate-y-0 fixed md:relative bg-light shadow-xl md:shadow-none rounded-lg border md:border-0 md:bg-transparent top-16 md:top-0 right-[180px] md:right-0 h-fit w-fit min-w-[165px] md:w-fit px-6 sm:px-8 py-4 md:px-0 translate-x-full md:translate-x-0 transition duration-200"
            >
              <ul className="flex items-center md:justify-center flex-col md:flex-row md:mt-0 w-full">
                ...
                <Link
                  to="/pricing"
                  className="bg-primary text-white rounded-lg px-2 sm:px-5 py-1.5 sm:py-2 text-sm font-medium flex shrink-0 transition duration-200 active:scale-100 hover:scale-90"
                >
                  Our Pricing
                </Link>
              </ul>
