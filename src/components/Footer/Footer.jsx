      ...
      <div className='w-[90%] max-w-[1200px] flex flex-col md:flex-row justify-between items-center py-10 mx-auto'>
        ...
        <div className='mt-5 md:mt-0 ml-0 md:ml-8'>
          ...
          <div className="flex justify-center gap-5">
            <a target='_blank' rel="noreferrer" href='https://www.facebook.com/profile.php?id=100077122898842'>
            ...
            <a target='_blank' rel="noreferrer" href='https://www.instagram.com/p/CbNH1zoIrag/?igshid=YmMyMTA2M2Y= '>
            ...
            <a target='_blank' rel="noreferrer" href='https://twitter.com/Ridot_software?s=20'>
            ...
            <a target='_blank' rel="noreferrer" href='https://www.linkedin.com/in/ridot-software-academy'>
